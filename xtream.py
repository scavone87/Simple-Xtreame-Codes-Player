...
def get_single_channel_URL(channel_id):
    URL = '%s/player_api.php?username=%s&password=%s&action=%s&sub=%s&stream_ids[]=%s' % (server, username, password, 'stream', 'start',channel_id)
    return URL
